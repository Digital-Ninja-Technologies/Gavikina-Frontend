...
export const APPLIANCES: Appliance[] = [
  { id: 'led', name: 'LED bulbs', category: 'Lighting', typical_wattage: 10, default_quantity: 0 },
  { id: 'seclight', name: 'Security lights', category: 'Lighting', typical_wattage: 100, default_quantity: 0 },
  { id: 'fanstand', name: 'Standing fan', category: 'Cooling', typical_wattage: 60, default_quantity: 0 },
  { id: 'fanceil', name: 'Ceiling fan', category: 'Cooling', typical_wattage: 75, default_quantity: 0 },
  { id: 'ac1', name: 'Air conditioner — 1HP', category: 'Cooling', typical_wattage: 750, default_quantity: 0 },
  { id: 'ac15', name: 'Air conditioner — 1.5HP', category: 'Cooling', typical_wattage: 1200, default_quantity: 0 },
  { id: 'tv', name: 'TV — 43" LED', category: 'Living', typical_wattage: 100, default_quantity: 0 },
  { id: 'decoder', name: 'Decoder / set-top box', category: 'Living', typical_wattage: 30, default_quantity: 0 },
  { id: 'router', name: 'Wi-Fi router', category: 'Living', typical_wattage: 15, default_quantity: 0 },
  { id: 'laptop', name: 'Laptop', category: 'Living', typical_wattage: 65, default_quantity: 0 },
  { id: 'phones', name: 'Phone charging', category: 'Living', typical_wattage: 15, default_quantity: 0 },
  { id: 'fridge', name: 'Fridge — small/medium', category: 'Kitchen', typical_wattage: 150, default_quantity: 0 },
  { id: 'freezer', name: 'Chest freezer', category: 'Kitchen', typical_wattage: 250, default_quantity: 0 },
  { id: 'dispenser', name: 'Water dispenser', category: 'Kitchen', typical_wattage: 550, default_quantity: 0 },
  { id: 'blender', name: 'Blender', category: 'Kitchen', typical_wattage: 400, default_quantity: 0 },
  { id: 'microwave', name: 'Microwave', category: 'Kitchen', typical_wattage: 1200, default_quantity: 0 },
  { id: 'iron', name: 'Electric iron', category: 'Utility', typical_wattage: 1000, default_quantity: 0 },
  { id: 'washer', name: 'Washing machine', category: 'Utility', typical_wattage: 500, default_quantity: 0 },
  { id: 'pump', name: 'Water pump', category: 'Utility', typical_wattage: 750, default_quantity: 0 },
  { id: 'pos', name: 'POS terminal + printer', category: 'Business', typical_wattage: 200, default_quantity: 0 },
  { id: 'desktop', name: 'Desktop workstation', category: 'Business', typical_wattage: 250, default_quantity: 0 },
  { id: 'coldroom', name: 'Display chiller', category: 'Business', typical_wattage: 900, default_quantity: 0 },
];
