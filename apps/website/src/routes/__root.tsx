...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { property: 'og:description', content: 'Solar systems sized to what you actually run — installed, commissioned, and owned outright by you.' },
      ...
      { name: 'twitter:description', content: 'Solar systems sized to what you actually run — installed, commissioned, and owned outright by you.' },
