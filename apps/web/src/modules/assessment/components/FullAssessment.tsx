						...
						return (
							<div
								...
								className={cn(
									...
									active ? "bg-white/9" : "bg-transparent",
								)}
							>
								<span
									className={cn(
										...
										active
											? "bg-green text-white"
											: past
												? "bg-green/28 text-green-light"
												: "bg-white/9 text-white/45",
									)}
								>
									{past ? "✓" : String(i + 1)}
								</span>
			...
			<div className="flex min-h-130 min-w-0 flex-col p-8.5 pb-7.5 pt-8.5 max-[560px]:p-5.5">
				{step === 0 && !done && (
					<div className="animate-gv-fade">
						<h3 className="m-0 text-[26px] font-semibold tracking-tight">
						...
						<div className="grid max-w-150 grid-cols-2 gap-3.5 max-[480px]:grid-cols-1">
							{[
								...
								>
									...
									<span className="text-[13px] leading-snug text-navy/58">
										{o.note}
									</span>
								</button>
							))}
							...
							{groups.map((group) => (
								<div key={group.name}>
									<div className="mb-2.25 flex items-center gap-2.5">
										<span className="text-[11px] font-semibold uppercase tracking-widest text-navy/45">
											{group.name}
										</span>
											...
											return (
												<div
													...
													className={cn(
														...
														on
															? "border-green/50 bg-green/7"
															: "border-navy/13 bg-white",
													)}
												>
													<button
														type="button"
													...
													{on && (
														<span className="ml-0.5 flex items-center gap-0.75 border-l border-green/35 pl-1.75">
															...
															<span className="min-w-3.5 text-center text-[12.5px] font-semibold">
																{qty}
															</span>
															<button
																type="button"
				...
				{step === 3 && !done && (
					<div className="animate-gv-fade">
						...
						<p className="mb-6.5 mt-2 text-sm text-navy/60">
							This sets the battery bank, not the panel array.
						</p>
				...
				{step === 4 && !done && (
					<div className="animate-gv-fade">
						...
						<p className="mb-7.5 mt-2 text-sm text-navy/60">
					...
					<div className="min-w-0 animate-gv-fade">
						...
						<div className="mt-3.5 grid grid-cols-2 gap-4 max-[480px]:grid-cols-1">
							<div className="relative overflow-hidden rounded-2xl bg-ink p-5.5 text-white">
								...
								<div className="relative">
									...
									<div className="mt-1 text-[44px] font-semibold leading-[1.05] tracking-tight">
							...
							<div className="rounded-2xl border border-navy/10 bg-cream p-5.5">
								...
								<div className="mt-3.5 flex flex-col gap-2.75">
									{compareRows.map((r) => (
										<div
											key={r.label}
											className="flex items-baseline justify-between gap-3 border-b border-navy/9 pb-2.25"
										>
											<span className="text-[12.5px] leading-snug text-navy/65">
												{r.label}
											</span>
						...
						<div className="mt-4 rounded-2xl border border-green/30 bg-green/5 px-5.5 py-5">
							<div className="mb-2.5 flex items-center gap-2.25">
								<span className="flex h-5.5 w-5.5 items-center justify-center rounded-md bg-green text-xs font-bold text-white">
									G
								</span>
								<span className="text-[11px] font-semibold uppercase tracking-widest text-green-dark">
				...
				{step === 7 && !done && (
					<div className="animate-gv-fade">
						...
						<p className="mb-6 mt-2 text-sm text-navy/60">
						...
						<div className="flex max-w-130 flex-col gap-2.25">
							{PAYMENT_METHODS.map((o) => (
								<button
									key={o.id}
									type="button"
									className={pillOption(payment === o.id)}
				...
				{done && (
					<div className="flex max-w-130 flex-1 animate-gv-fade flex-col items-start justify-center">
						<span className="flex h-11.5 w-11.5 items-center justify-center rounded-2xl bg-green text-[22px] font-semibold text-white">
							✓
						</span>
						<h3 className="m-0 mt-5 text-[28px] font-semibold tracking-tight">
							Assessment complete
						</h3>
						...
						<div className="mt-6 rounded-2xl bg-cream px-4.5 py-4 text-[13px] leading-relaxed text-navy/70">
							Reference <strong className="text-navy">{ref}</strong> — quote it
							when you call us on 0800 GAVIKINA.
						</div>
					...
					<div className="mt-auto flex flex-wrap items-center justify-between gap-4 pt-6.5">
						...
						<div className="flex items-center gap-4">
							...
							<Button
								...
								className={cn(
									!nextEnabled && "bg-navy/14 text-navy/40 hover:bg-navy/14",
								)}
								onClick={() => {
